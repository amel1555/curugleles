...
<body>
            ...
            <div class="card-body">
                    ...
                    <div class="row mb-2">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nama_pemesanan" class="form-control" placeholder="Nama Lengkap" aria-label="Nama Lengkap">
                        </div>
                        
                        <div class="col-md-6">
                        <label class="form-label">Nomor Handphone</label>
                        <input type="text" name="hp_pemesan" class="form-control" placeholder="Nomor Handphone" aria-label="Nomor Handphone">
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-md-6">
                        <label class="form-label">Waktu Berangkat</label>
                        <input type="date" name="waktu_wisata" class="form-control" placeholder="Waktu Berangkat" aria-label="Waktu Berangkat">
                        </div>
                        <div class="col-md-6">
                        <label class="form-label">Estimasi (Hari)</label>
                        <input type="number" name="hari_wisata" class="form-control" placeholder="Estimasi Hari" aria-label="Estimasi Hari">
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row mb-2">
                        ...
                        <input type="number" id="jumlah_peserta" name="jumlah_peserta" class="form-control" placeholder="Jumlah Peserta" aria-label="Jumlah Peserta" onchange="calculateTotal()">
                        </div>
                    </div>
                    <div class="row mb-2">
    ...
    <script>
        //fungsi calculate data untuk ngaliin yang jumlah peserta sama harga paketnya
        function calculateTotal() {
            //masukin nilai yang dari inputan ke dalam sebuah variabel
            ...
            const hargaPaket = paketInap + paketTransport + paketMakan; //ngitung harga paketnya, di tambah tambahin, diambil dari variabel di atas
            const jumlahPeserta = parseInt(document.getElementById('jumlah_peserta').value) || 0; // bikin hitungan ini untuk nge get jumlah peserta nya di jadiin int
            const totalTagihan = hargaPaket * jumlahPeserta; // untuk perhitungan total tagihannya dimana jumlah peserta di kali harga paket nya.

            //untuk nampilin langusng ketika di klik pakeat dann jumlah pesertanya, jadi lngsung muncul di situ harga total  nya berapa.
